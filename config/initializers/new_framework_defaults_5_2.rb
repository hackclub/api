...
# frozen_string_literal: true Be sure to restart your server when you modify
# this file.
#
...
# Use AES-256-GCM authenticated encryption for encrypted cookies. Existing
# cookies will be converted on read then written with the new scheme.
...
# messages instead of AES-256-CBC, when use_authenticated_message_encryption is
# set to true.
...
# header. Rails.application.config.active_support.use_sha1_digests = true
